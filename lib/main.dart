                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage("assets/Chizburger.png"),
                          fit: BoxFit.cover,
                        ),
                      ),
                      child: Stack(
    ...
    return  Align(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            SvgPicture.asset("assets/Home.png"),
            SvgPicture.asset("assets/Community.png"),
            SvgPicture.asset("assets/Categories.png"),
            SvgPicture.asset("assets/Profile.png"),
          ],
        ),
      ),
    );
